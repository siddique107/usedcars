    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card success-card p-5 text-center">
                ...
                <h2 class="text-success fw-bold">Car updated Successfully!</h2>
                <p class="lead mt-3">
...
```
            ...
            <p class="mb-3"><strong>Status:</strong>  ${Car.status}</p>

            <div class="d-flex justify-content-center gap-3 mt-4">
                <a href="/newcar" class="btn btn-custom text-white px-4">
